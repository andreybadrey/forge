package com.bodryak.gmod.item.weapone.distanse;

import com.bodryak.gmod.variables.server.ProviderItemStak;
...
public class TestBow extends BowItem {
    ...
    public TestBow(Item.Properties p_40660_) {
        super(p_40660_);
    }
    ...
    public void releaseUsing(ItemStack p_40667_, Level p_40668_, LivingEntity p_40669_, int p_40670_) {
            //System.out.println(p_40667_.getTag());
    }

    @Override
    public void onUsingTick(ItemStack itemstacka, LivingEntity entityLiving, int count) {
        ItemStack p_40667_ = itemstacka;
        LivingEntity p_40669_ = entityLiving;
        int p_40670_ = count;
        Level p_40668_ = entityLiving.level;
        itemstacka.getCapability(ProviderItemStak.ITEM_DATA).ifPresent(ids -> {

            System.out.println(ids.getDamage());
        });
        if ((p_40669_ instanceof Player player) && (entityLiving.getUseItemRemainingTicks()) == 1) {
